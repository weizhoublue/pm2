...
function renderExitTime(lastExitAt) {
  ...
  return new Date(lastExitAt).toISOString().replace('T', ' ').slice(0, 19)
}
...
function listModulesAndAppsManaged(list, commander) {
  ...
  var sortField = 'name', sortOrder = 'asc', sort,
      fields = {
        ...
        lastExitCode: 'pm2_env.last_exit_code',
        lastExitTime: 'pm2_env.last_exit_at',
        totalRound: 'pm2_env.start_count',
